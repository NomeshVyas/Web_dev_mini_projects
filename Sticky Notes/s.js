...
function createNote() {
    ...
    note.setAttribute("style", "width: 245px; color: white; height: 260px; font-size: 1rem; position: relative; padding: 0.5rem; padding-top: 1.35rem; text-align: center;  box-shadow: 5px 10px 15px gray;");
    x.setAttribute("style", "font-size: 1.2rem; position: absolute; right:5px; top: 5px;");
...
function randomRotate() {
    var rotate = ['rotate(-3deg)', 'rotate(1deg)', 'rotate(-1deg)', 'rotate(3deg)', 'rotate(-5deg)', 'rotate(4deg)']
